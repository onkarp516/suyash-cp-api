...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tranx_purchase_return_details_units_tbl")
public class TranxPurReturnDetailsUnits {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;

    @ManyToOne
    @JoinColumn(name = "purchase_return_invoice_id")
    @JsonManagedReference
    private TranxPurReturnInvoice tranxPurReturnInvoice;

    @ManyToOne
    @JoinColumn(name = "purchase_return_details_id")
    @JsonManagedReference
