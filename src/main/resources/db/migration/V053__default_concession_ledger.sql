...
DROP PROCEDURE if EXISTS default_concession_ledger;
DELIMITER &&
CREATE PROCEDURE default_concession_ledger(IN branch_id BIGINT,IN outlet_id BIGINT,IN created_by BIGINT)
BEGIN
    ...
    VALUES
   ('Concession A/C', NULL, 'INEX', 'NA', 'NA', 0, 'NA', 0, 'NA', 0, b'0', 'NA', 'NA',   NULL, NULL, 'NA', 'NA', 'NA', 'NA', 'NA', 'NA',
