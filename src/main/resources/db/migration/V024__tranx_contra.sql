...
CREATE TABLE tranx_contra_details_tbl (
  id BIGINT AUTO_INCREMENT NOT NULL,
   ...
   tranx_contra_master_tbl BIGINT NULL,
...
ALTER TABLE tranx_contra_details_tbl ADD CONSTRAINT FK_TRANX_CONTRA_DETAILS_TBL_ON_TRANX_CONTRA_MASTER_TBL FOREIGN KEY (tranx_contra_master_tbl) REFERENCES tranx_contra_master_tbl (id);
