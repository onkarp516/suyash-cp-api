...
SELECT EXISTS (SELECT * FROM ledger_balance_summary_tbl WHERE ledger_balance_summary_tbl.ledger_master_id=LEDGER_MST_ID) INTO CHECKBALEXIST;
  ...
  UPDATE ledger_balance_summary_tbl SET ledger_balance_summary_tbl.balance=CLOSING_BAL,ledger_balance_summary_tbl.closing_bal=CLOSING_BAL,ledger_balance_summary_tbl.credit=CREDIT_AMT,ledger_balance_summary_tbl.debit=DEBIT_AMT, ledger_balance_summary_tbl.updated_at=NOW() WHERE ledger_balance_summary_tbl.ledger_master_id=LEDGER_MST_ID;
  ELSE
